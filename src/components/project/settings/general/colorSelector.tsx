      ...
      >
        ...
        <Popover.Panel className="rounded-xl border border-gray-200 bg-white shadow-lg focus:outline-none ">
          ...
          <div className="relative flex w-48 flex-col justify-center gap-5 overflow-hidden rounded-xl bg-white px-7 py-5">
            ...
            <button
              onClick={handleSave}
              className="text-md w-full rounded-lg bg-indigo-500 px-2 py-2.5 text-center font-medium text-white hover:bg-indigo-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:w-auto"
            >
              Save
            </button>
          </div>
