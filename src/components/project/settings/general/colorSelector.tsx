...
const ColorSelector: React.FC<{
	...
	return (
		<Popover className='relative'>
			...
			>
				<Popover.Button className='w-full rounded-lg bg-indigo-500 px-2.5 py-2.5 text-center text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300 hover:bg-indigo-800 dark:bg-blue-600 dark:focus:ring-blue-800 dark:hover:bg-blue-700 sm:w-auto'>
					Change icon
				</Popover.Button>
