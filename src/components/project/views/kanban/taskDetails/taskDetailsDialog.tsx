            ...
            <div className='flex min-h-full items-center justify-center p-4 text-center focus:outline-none'>
              ...
              >
                <Dialog.Panel className='min-w-[35vw] max-w-md transform rounded-2xl bg-white px-7 py-5 text-left align-middle shadow-xl transition-all'>
                  {isLoading ? (<TaskDetailsSkeletonLoader setOpen={setOpen} />) : (
                    <div>
                    ...
                    <div className='flex flex-col justify-center'>
                      ...
                      <Tab.Group>
                        <Tab.List className='flex items-center gap-5 border-b border-b-gray-200'>
                          <Tab
                            className={({ selected }) =>
                              `text-md inline-flex select-none items-center gap-1.5 border-b-[0.13rem] px-0.5 pb-1 font-medium focus:outline-none ${
                                selected
                          ...
                          <Tab
                            className={({ selected }) =>
                              `text-md select-none border-b-[0.13rem] px-0.5 pb-1 font-medium focus:outline-none ${
                                selected
                                  ? 'border-b-indigo-500 text-indigo-500'
                                  : 'border-b-white text-gray-500'
                              }`
