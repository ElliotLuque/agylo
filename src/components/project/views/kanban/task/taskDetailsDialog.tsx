...
import LabelSelector from '../../../../taskDetails/labels/labelSelector'
                  ...
                  <div className='flex flex-col justify-center'>
                    <div className='grid w-[22rem] grid-cols-[8rem_1fr] grid-rows-5 gap-y-1.5 pl-1'>
                      ...
                      <div className='row-start-2 flex items-center gap-1'>
                        <AssigneeSelector
                          ...
                          assigneeImage={taskData?.assignee?.image as string}
                      ...
                      <div className='row-start-4 flex items-center cursor-pointer'>
                        <p className='text-sm text-gray-800'>30 Feb, 2022</p>
                      </div>
                    ...
                    <Tab.Group>
                      <Tab.List className='flex items-center gap-5 border-b border-b-gray-200'>
                        <Tab
                          className={({ selected }) =>
                            `text-md inline-flex select-none focus:outline-none items-center gap-1.5 border-b-[0.13rem] px-0.5 pb-1 font-medium ${
                              selected
                        ...
                        <Tab
                          className={({ selected }) =>
                            `text-md select-none focus:outline-none border-b-[0.13rem] px-0.5 pb-1 font-medium ${
                              selected
                                ? 'border-b-indigo-500 text-indigo-500'
                                : 'border-b-white text-gray-500'
                            }`
